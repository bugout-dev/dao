...
class TerminusFacet:
    ...
    def get_controller_pools(self, controller: ChecksumAddress) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.getControllerPools.call(controller)
...
def handle_get_controller_pools(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = TerminusFacet(args.address)
    result = contract.get_controller_pools(controller=args.controller)
    print(result)
...
def generate_cli() -> argparse.ArgumentParser:
    ...
    get_controller_pools_parser = subcommands.add_parser("get-controller-pools")
    add_default_arguments(get_controller_pools_parser, False)
    get_controller_pools_parser.add_argument(
        "--controller", required=True, help="Type: address"
    )
    get_controller_pools_parser.set_defaults(func=handle_get_controller_pools)
