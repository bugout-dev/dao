...
class ERC1155WithTerminusStorageFixture:
    def __init__(self, contract_address: Optional[ChecksumAddress]):
        self.contract_name = "ERC1155WithTerminusStorageFixture"
        self.address = contract_address
        self.contract = None
        self.abi = get_abi_json("ERC1155WithTerminusStorageFixture")
...
def handle_deploy(args: argparse.Namespace) -> None:
    ...
    contract = ERC1155WithTerminusStorageFixture(None)
...
def handle_verify_contract(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = ERC1155WithTerminusStorageFixture(args.address)
...
def generate_cli() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="CLI for ERC1155WithTerminusStorageFixture"
    )
