...
class ERC20Initializer:
    ...
    def init(self, name: str, symbol: str, transaction_config) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.init(name, symbol, transaction_config)
...
def generate_cli() -> argparse.ArgumentParser:
    ...
    init_parser.add_argument("--name", required=True, help="Type: string", type=str)
    init_parser.add_argument("--symbol", required=True, help="Type: string", type=str)
