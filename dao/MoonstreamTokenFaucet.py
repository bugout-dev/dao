...
class MoonstreamTokenFaucet:
    ...
    def get_faucet_amount(
        self, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.getFaucetAmount.call(block_identifier=block_number)

    def get_faucet_block_interval(
        self, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.getFaucetBlockInterval.call(block_identifier=block_number)

    def get_last_claimed_block(
        self,
        _address: ChecksumAddress,
        block_number: Optional[Union[str, int]] = "latest",
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.getLastClaimedBlock.call(
            _address, block_identifier=block_number
        )

    def get_moonstream_token_address(
        self, block_number: Optional[Union[str, int]] = "latest"
    ) -> Any:
        self.assert_contract_is_instantiated()
    ...
    def get_moonstream_token_balance(
        self,
        _address: ChecksumAddress,
        block_number: Optional[Union[str, int]] = "latest",
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.getMoonstreamTokenBalance.call(
            _address, block_identifier=block_number
        )
...
def handle_get_faucet_amount(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = MoonstreamTokenFaucet(args.address)
    result = contract.get_faucet_amount(block_number=args.block_number)
    print(result)
...
def handle_get_faucet_block_interval(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = MoonstreamTokenFaucet(args.address)
    result = contract.get_faucet_block_interval(block_number=args.block_number)
    print(result)
...
def handle_get_moonstream_token_address(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = MoonstreamTokenFaucet(args.address)
    result = contract.get_moonstream_token_address(block_number=args.block_number)
    print(result)
